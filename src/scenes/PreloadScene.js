...
import assetHero2 from '../assets/hero.png';
import assetHero3 from '../assets/hero2.png';
...
export default class PreloadScene extends Phaser.Scene {
    preload() {
        ...
        this.load.spritesheet('hero2', assetHero2, { frameWidth: 84, frameHeight: 160 });
        this.load.spritesheet('hero3', assetHero3, { frameWidth: 84, frameHeight: 160 });
